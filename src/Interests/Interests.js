  ...
  return (
    ...
    <br/><br/>
      ...
      <div className="activity">
        ...
        <p className="description">I operated the welcome center, greeted and directed hospital visitors and patients in finding rooms, clinic, or departments at the Lakeside Hospital. Additionally, I trained and supervised teen volunteers in departments to ensure they were comfortable and satisfied in their positions.</p>
      </div>
      <div className="activity">
